...
Public Class AdvancedEditor
    ...
    Dim WithEvents NewLoadingWindow As New SyncWindow() With {.Title = "Translating", .ShowActivated = True}
    ...
    Private Function TranslateText(RequestedLanguage As String, TextToTranslate As String) As String
        ...
        Dim NewTranslationRequest As New Translations.TranslationRequest() With {.q = TextToTranslate, .source = "auto", .target = RequestedLanguage}
        ...
        If Not String.IsNullOrEmpty(RequestResponseString) Then
            Dim ParsedTranslation As Translations.ReceivedTranslation = JsonConvert.DeserializeObject(Of Translations.ReceivedTranslation)(RequestResponseString)
    ...
    Private Async Sub TranslateXML(NewLanguage As String)
        ...
        If Dispatcher.CheckAccess() = False Then
            Await Dispatcher.BeginInvoke(Sub()
                                             NewLoadingWindow = New SyncWindow() With {.Title = "Translating", .ShowActivated = True, .Width = 650, .Height = 175}
