...
Public Class SimpleGraphicsEditor
    ...
    Private Sub ReplaceColorMenuItem_Click(sender As Object, e As RoutedEventArgs) Handles ReplaceColorMenuItem.Click
        ...
        Dim NewColorSelector As New ColorSelection() With {.Title = "Select the color to replace"}
        Dim NewColorSelector2 As New ColorSelection() With {.Title = "Select the new color to apply"}
